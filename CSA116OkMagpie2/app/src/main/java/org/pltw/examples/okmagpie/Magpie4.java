...
public class Magpie4
{
	...
	public String getResponse(String statement)
	{
		...
		else if (findKeyword(statement, "Can you help me with", 0) >= 0){
			response = transformCanHelpStatement(statement);
		}
		else
		{
	 ...
	 */
	private String transformCanHelpStatement(String statement)
	{
		...
		int psn = findKeyword(statement, "Can you help me with ", 0);
		String restOfStatement = statement.substring(psn+21).trim();
		return "Sure I can help you with " + restOfStatement;
	}
	...
	private String transformIWantStatement(String statement)
	{
		...
		return "I do not think I can give you " + restOfStatement;
	}
	...
	{
		String[] response = {"Interesting, tell me more.","Hmmm.",
